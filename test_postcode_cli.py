...
@pytest.mark.parametrize(
    "postcode",
    ["YYYYYY", "123456", "it is a truth universally acknowledged", "9", "Darkest Peru"],
)
...
@pytest.mark.parametrize("postcode", ["TN1 2FB", "SW2 3HJ", "YO11 1AA", "M2 1AB"])
...
@pytest.mark.parametrize(
    "postcode", ["EH14 2AAFF", "palanquin", "123456", "000001", "The Emperor Nero"]
)
...
def test_cli_outputs_fewer_than_five_completions_when_relevant(
    postcode, run_shell_command
):
